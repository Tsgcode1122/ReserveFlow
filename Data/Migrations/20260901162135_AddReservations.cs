    ...
    public partial class AddReservations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResourceAmenities", x => new { x.AmenitiesId, x.ResourcesId });
                    table.ForeignKey(
                        name: "FK_ResourceAmenities_Amenities_AmenitiesId",
                        column: x => x.AmenitiesId,
                        principalTable: "Amenities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ResourceAmenities_Resources_ResourcesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResourceAmenities_ResourcesId",
                table: "ResourceAmenities",
                column: "ResourcesId");
        }
